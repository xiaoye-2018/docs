...
```
  ...
  <Tip>
  **Setup**
  To use `MongoDBSaver`, you will need a MongoDB cluster. Follow [this guide](https://www.mongodb.com/docs/guides/atlas/cluster/) to create a cluster if you don't already have one. For an agent-focused walkthrough, see [short-term memory with MongoDB Atlas](/oss/integrations/memory/mongodb-short-term-memory).
  </Tip>
...
<Accordion title="Example: using MongoDB store">
  ...
  <Tip>
  For an agent-focused walkthrough, see [long-term memory with MongoDB Atlas](/oss/integrations/memory/mongodb-long-term-memory).
  </Tip>
